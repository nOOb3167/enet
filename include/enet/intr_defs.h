...
ENET_API struct ENetIntrToken *            enet_intr_token_create_win32 (const struct ENetIntrTokenCreateFlags * flags);
...
ENET_API struct ENetIntrToken *            enet_intr_token_create_unix (const struct ENetIntrTokenCreateFlags * flags);
